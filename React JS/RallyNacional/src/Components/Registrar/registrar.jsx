        ...
        <div>
            <main className="main">
                <section className="section__formulario">
                    <form  id="Registro-form" className="section__formulario-form align-self-center" onSubmit={(event) => signIn(event)}>
                        ...
                        <div className="row d-flex justify-content-center">
                            <div className="form-group col-md-10">
                                ...
                                <div className="row mb-3">
                                    ...
                                    <input required type="text" className="form-control" id="name" name="name"
                                           placeholder="Ingrese el Usuario" onChange={handleChange} />
                                </div>
                            ...
                            <div className="form-group col-md-10">
                                <div className="row mb-3">
                                    ...
                                    <input required type="password" className="form-control" id="password" name="password"
                                           placeholder="Confirme su password" onChange={handleChange}/>
                                </div>
                            ...
                            <div className="col-md-10 ">
                                <div className="row mb-3">
                                    ...
                                    <i className="fa fa-sign-in"><FaSignInAlt></FaSignInAlt></i> Registrarse
                                </button>
                                </div>
                            </div>
                        </div>
