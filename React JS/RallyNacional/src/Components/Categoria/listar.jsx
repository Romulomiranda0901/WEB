...
import ModalActualizar from "./ActualizarCategoria";
...
const listar =() =>
 {
    ...
    const [row1,setRow] =useState({});
     ...
     // eslint-disable-next-line react-hooks/rules-of-hooks
     useEffect(() => fetchList("categorias", setRows), [estado]);
     ...
     const deleteCategoria = (id) => {
         ...
         fetchDelete('categorias', setEstado, {}, {id})
     ...
     function iconAcion(cell, row, rowIndex, formatExtraData)
     {
         ...
         return (
                 ...
                 <div className='row justify-content-center row-cols-2 row-cols-lg-5 g-2 g-lg-3'>
                     ...
                     <div className="col "> <button onClick= {()=>deleteCategoria(row.id)}  className='btn btn-danger'><FaTrash /></button></div>
                 </div>
         );
     }
