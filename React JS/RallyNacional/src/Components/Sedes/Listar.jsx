...
import ModalAgregar from "../Sedes/agregarSede";
import ActualizarSedes from "./actualizarSedes";
    ...
    function iconAcion(cell, row, rowIndex, formatExtraData)
    {
        ...
        return (
            ...
            <div className='row justify-content-center row-cols-2 row-cols-lg-5 g-2 g-lg-3'>
                <div className="col ">
                    <ActualizarSedes row ={row} setEstado={setEstado} />
                </div>
